"""
Verify that your environment is set up correctly for the Prompt Engineering & RAG course.
"""
...
def check_api_keys():
    ...
    for key, name in keys.items():
        if os.environ.get(key):
            ...
            results.append(optional)  # Optional keys don't fail the check
    
    return all(results)

def main():
    print("=" * 60)
    print("PROMPT ENGINEERING & RAG COURSE - SETUP VERIFICATION")
    print("=" * 60)
    ...
    all_good &= check_package('sentence-transformers', 'sentence_transformers')
    ...
    # Document Processing
    print("\n📋 Document Processing:")
    all_good &= check_package('pypdf')
    
    # Utilities
    print("\n📋 Utilities:")
    all_good &= check_package('pydantic')
    all_good &= check_package('tiktoken')
